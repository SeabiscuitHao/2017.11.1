<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"F:\www\youme\think\public/../application/index\view\cate\cate.html";i:1509542129;s:68:"F:\www\youme\think\public/../application/index\view\common\head.html";i:1509531295;s:70:"F:\www\youme\think\public/../application/index\view\common\footer.html";i:1508655809;}*/ ?>
...
<div class="post single-post cate2 auth1">
	<!-- <div class="post-nav">
		<a class="l" href="http://www.youmew.com/post/74.html" title="初冬，景如故">« 上一篇</a><a class="r" href="http://www.youmew.com/post/76.html" title="人生何尝不是一场赌局">下一篇 »</a>
	</div> -->
		<?php if(is_array($articleres) || $articleres instanceof \think\Collection || $articleres instanceof \think\Paginator): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			...
			<h2 class="post-title"><?php echo $vo['title']; ?></h2>
			<div class="post-body">
			...
			<h6	 class="post-footer">
				发布:<?php echo $vo['author']; ?> 浏览:<?php echo $vo['click']; ?><span id="spn75"></span>
